    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Builder(
            builder: (context) {
              final iconWidth = isSmartwatch ? 20.0 : 28.0;
              final iconStyle = isSmartwatch
                  ...
                  Card(
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        HapticFeedback.mediumImpact();
                        context.pushNamed(
                          AppRouteConstant.ACTIVITY.name,
                          extra: 0,
                        );
                      },
                      child: Padding(
                        padding: const EdgeInsets.all(6.0),
                        child: Icon(
                          PhosphorIcons.notification(iconStyle),
                          size: iconWidth,
                  ...
                  Card(
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(6.0),
                        child: Icon(
                          PhosphorIcons.calendar(iconStyle),
                          size: iconWidth,
                          color: Colors.white.withValues(alpha: 0.9),
                        ),
                      ),
                      ...
                      builder: (context, ref, child) {
                        ...
                        return InkWell(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(6.0),
                            child: Icon(
                              PhosphorIcons.listMagnifyingGlass(iconStyle),
                              size: iconWidth,
                              color: Colors.white.withValues(alpha: 0.9),
                            ),
                          ),
                        ...
                        child: Card(
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(6.0),
                              child: Icon(
                                PhosphorIcons.images(iconStyle),
                                size: iconWidth,
                                color: Colors.white.withValues(alpha: 0.9),
                              ),
                            ),
                  ...
                  Card(
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(6.0),
                        child: Icon(
                          PhosphorIcons.bowlFood(iconStyle),
                          size: iconWidth,
                          color: Colors.white.withValues(alpha: 0.9),
                        ),
                      ),
                  ...
                  Card(
                    ...
                    child: InkWell(
                      ...
                      onTap: () => context.pushNamed(
                        AppRouteConstant.NewsScreenScreen.name,
                      ),
                      child: Padding(
                        padding: const EdgeInsets.all(6.0),
                        child: Icon(
                          PhosphorIcons.newspaper(iconStyle),
                          size: iconWidth,
                          color: Colors.white.withValues(alpha: 0.9),
                        ),
                      ),
