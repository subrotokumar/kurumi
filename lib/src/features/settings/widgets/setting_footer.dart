        ...
        Row(
          ...
          children: [
            ...
            IconButton(
              ...
              icon: const LineIcon.github(size: 30, color: Colors.black),
            ),
            IconButton(
              style: IconButton.styleFrom(
                backgroundColor: Colors.white70,
              ...
              icon: const LineIcon.twitter(color: Colors.black, size: 30),
            ),
            IconButton(
              style: IconButton.styleFrom(
                backgroundColor: Colors.white70,
              ...
              icon: const LineIcon.googlePlay(color: Colors.black, size: 30),
            ),
            const Card(),
            const Card(),
          ],
