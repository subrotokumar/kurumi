...
class ReviewByIdScreen extends ConsumerWidget {
  const ReviewByIdScreen({required this.id, super.key});
  final int id;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Operation(
      operationRequest: GGetReviewByIdReq((b) => b..vars.id = id),
      ...
      builder: (context, response, error) {
        if (response?.loading ?? true) {
          ...
          return GestureDetector(
            ...
            child: Scaffold(
              body: Center(
                child: Chip(label: Text('Not Found', style: Poppins())),
              ),
            ),
          );
        } else {
