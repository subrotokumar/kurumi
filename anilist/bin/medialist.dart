import 'package:anilist/graphql/__generated__/schema.ast.gql.dart';
...
void main(List<String> args) {
  ...
  final req = GMediaListCollectionReq((b) => b
    ..vars.status = GMediaListStatus.COMPLETED
    ..vars.type = GMediaType.ANIME
    ..vars.userId = 123);
  client.request(req).listen((event) {
    print(event.data?.MediaListCollection?.lists?.elementAt(0)?.entries?.first);
  });
}
